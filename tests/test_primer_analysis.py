...
def test_analyze_primers_and_hairpins_basic(primer_df, expected_primer_analysis):
    ...
    if result_cols != expected_cols:
        ...
        print("Columns missing in expected_primer_analysis:", result_cols - expected_cols)
    ...
    numeric_cols = [
        'homodimer_forward_tm', 'homodimer_forward_deltaG (kcal/mol)',
    ...
    expected_primer_analysis.loc[:, numeric_cols] = expected_primer_analysis[numeric_cols].round(2)
