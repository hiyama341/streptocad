    ...
    def run_workflow(n_clicks, genome_content, vector_content, genome_filename, vector_filename, genes_to_KO, 
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tempdir:
                ...
                logging.info("Constructing names, IDs, and descriptions for assembled plasmids.")
                targeting_info = []
                ...
                for i in range(len(assembled_cas3_plasmids)):
                    ...
                    assembled_cas3_plasmids[i].description = f'Assembled plasmid targeting {", ".join(genes_to_KO_list)} for single gene knockout, assembled using StreptoCAD.'
                ...
                if in_frame_deletion == [1]: 
                    logging.info("Extracting metadata for plasmid assembly with in-frame deletion.")
                ...
                logging.info("Creating a copy of checking primers DataFrame and renaming columns.")
                ...
                if in_frame_deletion == [1]: 
                    logging.info("Concatenating full IDT DataFrame with in-frame deletion primers.")
                    ...
                    logging.info("Concatenating full IDT DataFrame without in-frame deletion primers.")
