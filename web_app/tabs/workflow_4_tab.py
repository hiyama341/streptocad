...
crispri_tab = html.Div(
    children=[
        ...
        html.Img(
            src="/assets/w4_pic.png", style={"width": "60%", "margin": "20px auto"}
        ),
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H5(
                                            "CRISPRi plasmid (GenBank format)",
                                            className="card-title",
                                            style=text_style,
                                        ),
                                        upload_component_with_display(
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        html.H4(
                            "3) Choose genes/regions to knock down", style=text_style
                        ),
                        dbc.Card(
                            [
                                dbc.CardBody(
            ...
            [
                dbc.Col(
                    [
                        ...
                        html.P(
                            "Per default the overhangs work with the example pCRISPR-dCas9.gbk plasmid.",
                            className="lead",
                            style=text_style,
                        ),
                    ],
                            ...
                            [
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        create_tooltip(
                                            "Set the maximum allowed off-target score for sgRNA filtering.",
                                            "off-target-upper-tooltip-4",
                                        ),
                                    ],
                                    width=12,
                                    className="mb-3",
                                ...
                                dbc.Col(
                                    [
                                        dbc.Label(
                                            [
                                                "Extension to Promoter Region ",
                                                html.Span(
                                                    "ⓘ",
                                                    id="extension-to-promoter-region-tooltip",
                                                    style=link_style,
                                                ),
                                            ],
                                            style={"color": "#ddd"},
                                        ...
                                        create_tooltip(
                                            "Set the length for promoter region extension in gene silencing.",
                                            "extension-to-promoter-region-tooltip",
                                        ),
                                    ],
                                    width=12,
                                    className="mb-3",
            ...
            [
                dbc.Label(
                    [
                        ...
                        html.Span(
                            "ⓘ", id="restriction-enzymes-tooltip-4", style=link_style
                        ),
                    ],
                    style={"color": "#ddd"},
                ),
