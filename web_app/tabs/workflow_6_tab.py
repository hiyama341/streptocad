...
cas3_tab = dcc.Tab(
    label="CRISPR–Cas3 plasmid construction",
    children=[
        dbc.Row(
            [
                dbc.Col(
        ...
        html.Img(
            src="/assets/w6_pic.png", style={"width": "60%", "margin": "20px auto"}
        ),
                                ...
                                dbc.CardBody(
                                    [
                                        ...
                                        dcc.Upload(
                                            id={
                                                "type": "upload-component",
                                                "index": "single-vector-6",
                                            },
                                            children=html.Div(
                                                [
                                                    "Drag and Drop or ",
                                                    html.A(
                                                        "Select CRISPR Plasmid File",
                                                        style=link_style,
                                                    ),
                                                ],
                                                style=text_style,
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        html.H4(
                            "4) Select overhangs (for Gibson reaction)",
                            style=text_style,
                        ),
                        html.P(
                            "Please enter the 5' and 3' annealing sequences below for the first Gibson reaction.",
                            className="lead",
                            style=text_style,
                        ),
                        html.P(
                            "Per default, the overhangs work with pCRISPR–Cas3.gbk",
                            className="lead",
                            style=text_style,
                        ),
                    ],
            ...
            [
                dbc.Col(
                    [
                        html.Label(
                            [
                                "Protospacer - 5 prime anneal:",
                                html.Span(
                                    "ⓘ",
                                    id="forward-overhang-tooltip-6",
                                    style=link_style,
                                ),
                            ],
                            style=text_style,
            ...
            [
                dbc.Col(
                    [
                        html.Label(
                            [
                                "Protospacer - 3 prime anneal:",
                                html.Span(
                                    "ⓘ",
                                    id="reverse-overhang-tooltip-6",
                                    style=link_style,
                                ),
                            ],
                            style=text_style,
            ...
            [
                dbc.Col(
                    [
                        html.Label(
                            [
                                "Backbone - 5 prime anneal:",
                                html.Span(
                                    "ⓘ",
                                    id="backbone-forward-overhang-tooltip-6",
                                    style=link_style,
                                ),
                            ],
                            style=text_style,
            ...
            [
                dbc.Col(
                    [
                        html.Label(
                            [
                                "Backbone - 3 prime anneal:",
                                html.Span(
                                    "ⓘ",
                                    id="backbone-reverse-overhang-tooltip-6",
                                    style=link_style,
                                ),
                            ],
                            style=text_style,
                                    ...
                                    [
                                            ...
                                            [
                                                dbc.Label(
                                                    [
                                                        ...
                                                        html.Span(
                                                            "ⓘ",
                                                            id="repair-templates-length-tooltip",
                                                            style=link_style,
                                                        ),
                                                    ],
                                                    style={"color": "#ddd"},
                                        ...
                                        dbc.Col(
                                            [
                                                dbc.Label(
                                                    [
                                                        "Restriction enzyme for integration of repair templates",
                                                        html.Span(
                                                            "ⓘ",
                                                            id="restriction-enzymes-tooltip-6",
                                                            style=link_style,
                                                        ),
                                                    ],
                                                    style={"color": "#ddd"},
            ...
            [
                dbc.Col(
                    [
                        ...
                        html.P(
                            "Note: adding repair templates to your plasmids",
