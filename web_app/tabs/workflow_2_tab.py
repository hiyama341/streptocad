...
crispr_cb_tab = html.Div(children=[
        ...
        dbc.Col([
            ...
            dbc.Card([
                dbc.CardBody([
                    ...
                    dcc.Upload(
                        id={'type': 'upload-component', 'index': 'genome-file-2'},
                        children=html.Div([
                            'Drag and Drop or ',
                    ...
                    html.Div(id={'type': 'filename-display', 'index': 'genome-file-2'}, children=[], style=text_style),
                ])
            ], style=card_style),
        ], width=6),
    ], className="mb-3"),
        ...
        dbc.Col([
            ...
            dbc.Card([
                dbc.CardBody([
                    ...
                    html.Div(id={'type': 'filename-display', 'index': 'single-vector-2'}, children=[], style=text_style),
                ])
            ], style=card_style),
        ], width=6),
    ], className="mb-5"),
    ...
    dbc.Row([
        dbc.Col([
            html.Label(['5 prime Overhang:', html.Span("ⓘ", id="forward-overhang-tooltip", style=link_style)], style=text_style),
            dbc.Input(
    ...
    dbc.Row([
        dbc.Col([
            html.Label(['3 prime Overhang:', html.Span("ⓘ", id="reverse-overhang-tooltip", style=link_style)], style=text_style),
            dbc.Input(
