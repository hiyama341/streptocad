...
from callbacks.workflow_1 import (
    register_workflow_1_callbacks,
)  # Import the new callback registration function
...
from callbacks.workflow_4 import (
    register_workflow_4_callbacks,
)  # Added callback registration for workflow 4
...
from callbacks_interactivity import (
    register_interactivity_callbacks,
)  # Import the interactivity callbacks
...
app.title = "StreptoCAD"  # This changes the browser tab title


# Customize the index_string to use your ICO file as the favicon.
app.index_string = """
<!DOCTYPE html>
<html>
    <head>
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.H2(
                            "Workflows", style={"color": "#ddd", "padding": "20px 0"}
                        ),  # Add a heading
                        dcc.Tabs(
                            id="main-tabs",
                            vertical=True,
                            style={"borderRight": "0.1px solid black"},
                            children=[
                                dcc.Tab(
                                    label="Workflow 1: Overexpression library construction",
                                    value="workflow_1",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                                dcc.Tab(
                                    label="Workflow 2: Single CRISPR-BEST plasmid generation",
                                    value="workflow_2",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                                dcc.Tab(
                                    label="Workflow 3: Multiplexed CRISPR-BEST plasmid generation",
                                    value="workflow_3",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                                dcc.Tab(
                                    label="Workflow 4: CRISPRi plasmid generation",
                                    value="workflow_4",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                                dcc.Tab(
                                    label="Workflow 5: CRISPR-Cas9 plasmid generation",
                                    value="workflow_5",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                                dcc.Tab(
                                    label="Workflow 6: CRISPR-Cas3 plasmid generation",
                                    value="workflow_6",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                                dcc.Tab(
                                    label="About StreptoCAD & Mission Statement",
                                    value="about",
                                    style=vertical_tab_style,
                                    selected_style=active_tab_style,
                                ),
                ...
                dbc.Col(
                    [html.Div(id="tab-content", style={"padding": "20px"})], width=9
                ),
            ]
        ),
        footer_content,
        #### ERROR BOX
        dcc.ConfirmDialog(id="error-dialog_1", message=""),
        dcc.ConfirmDialog(id="error-dialog_2", message=""),
        dcc.ConfirmDialog(id="error-dialog_3", message=""),
        dcc.ConfirmDialog(id="error-dialog_4", message=""),
        dcc.ConfirmDialog(id="error-dialog_5", message=""),
        dcc.ConfirmDialog(id="error-dialog_6", message=""),
    ],
    fluid=True,
    style={"backgroundColor": "#2C3E50", "padding": "20px", "color": "#ddd"},
)
...
@app.callback(
    Output("submit-output", "children"), [Input("submit-settings-button_1", "n_clicks")]
)
